...
then
  ...
  then
    ...
    echo "[Error] 올바른 스크립트 실행 경로가 아닙니다 프로젝트 루트나 script 디렉토리에서 bash 로 실행시켜 주세요"
    exit 1
  fi
fi
...
PATH_MDPI+='/assets/images'
PATH_HDPI=$MODULE_PATH
PATH_HDPI+='/assets/images/1.5x'
PATH_XHDPI=$MODULE_PATH
PATH_XHDPI+='/assets/images/2.0x'
PATH_XXHDPI=$MODULE_PATH
PATH_XXHDPI+='/assets/images/3.0x'
PATH_XXXHDPI=$MODULE_PATH
PATH_XXXHDPI+='/assets/images/4.0x'
